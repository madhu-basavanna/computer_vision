...
def parse_arguments():
    ...
    parser.add_argument('--data_folder', type=str, help="folder containing the data", default='/home/madhu/Desktop/dl_lab/cv_assignment/data/COCO_mini5class_medium')
    parser.add_argument('--pretrained_model_path', type=str, default='/home/madhu/Desktop/dl_lab/cv_assignment/data/pretrained_best.pth')
...
def main(args):
    ...
    model = AttSegmentator(5, pretrained_model.features, att_type='sdotprod').cuda()
