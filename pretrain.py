...
def parse_arguments():
    ...
    parser.add_argument('--data_folder', type=str, default='/home/madhu/Desktop/dl_lab/cv_assignment/data/crops/images/256', help="folder containing the data (crops)")
    parser.add_argument('--output-root', type=str, default='results')
    parser.add_argument('--epochs', type=int, default=10, help='number of epochs')
    parser.add_argument('--bs', type=int, default=80, help='batch_size')
